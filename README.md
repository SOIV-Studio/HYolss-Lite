# HYolss Lite (Discord BOT)

```
일단 이 봇에 대해 소개하기 전에 저를 먼저 소개합니다!

코딩을 할줄 모르고 오로지 AI를 사용하여 코딩을 하고 직접 계획과 작업을 진행하고 본업으로는 영상 작업을 하는 SOIV라고 합니다!

그리고 저는 유튜브에서 편집을 하고 가끔은 다른 형식의 영상을 작업을 하고는 합니다.

그리고 오시는 하츠네 미쿠입니다. 프로세카는 최고야!
```
